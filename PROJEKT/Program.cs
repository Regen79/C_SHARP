...
public class Uzytkownik
{
    ...
    {
        Console.WriteLine($"ID: {id}, Imiê: {imie}, Nazwisko: {nazwisko}");
    }
}
...
{
    public CzujnikWody(int id, string lokalizacja) : base(id, "Czujnik zu¿ycia wody", lokalizacja) { }

    public override string Odczyt()
    {
        return $"Zu¿ycie wody w {lokalizacja}: 10L/h";
    }
}
#endregion
...
public class ZgloszenieUsterki
{
    ...
    {
        Console.WriteLine($"ID: {id}, Opis: {opis}, Zg³aszaj¹cy: {zglaszajacy}, Status: {status}, Data: {data}");
    }
}
#endregion
...
public class KontrolaDostepu
{
    ...
    {
        string wpis = $"{DateTime.Now}: {u.imie} {u.nazwisko} wszed³ do budynku";
        logi.Add(wpis);
    ...
    {
        string wpis = $"{DateTime.Now}: {u.imie} {u.nazwisko} wyszed³ z budynku";
        logi.Add(wpis);
        Console.WriteLine(wpis);
        baza.ZapiszLogi(logi);
    }
    ...
    {
        Console.WriteLine("=== Logi Kontroli Dostêpu ===");
...
public class Aplikacja
{
    ...
    public void Menu()
    {
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("1. U¿ytkownicy");
                Console.WriteLine("2. Czujniki");
                Console.WriteLine("3. Zg³oszenia usterek");
                Console.WriteLine("4. Kontrola dostêpu");
                Console.WriteLine("5. Wyloguj");
            }
            else if (Zalogowany is Mieszkaniec)
            {
                Console.WriteLine("1. Dodaj zg³oszenie usterki");
                Console.WriteLine("2. Wejœcie/Wyjœcie z budynku");
                Console.WriteLine("3. Wyloguj");
            }
            else if (Zalogowany is Ochroniarz)
            {
                Console.WriteLine("1. Czujniki");
                Console.WriteLine("2. Zg³oszenia usterek");
                Console.WriteLine("3. Logi kontroli dostêpu");
            ...
            Console.WriteLine("Naciœnij ENTER aby kontynuowaæ...");
            Console.ReadLine();
        }
    }
    ...
    private void Logowanie()
    {
        ...
        Console.Write("Podaj ID u¿ytkownika: ");
    ...
    {
        Console.Clear();
        Console.WriteLine("1. Dodaj u¿ytkownika");
        ...
        {
            Console.Write("Podaj ID u¿ytkownika do usuniêcia: "); int id = int.Parse(Console.ReadLine());
            uzytkownicy.RemoveAll(x => x.id == id);
            Console.WriteLine("Usuniêto u¿ytkownika");
        }
    }
    #endregion
    ...
    private void MenuCzujniki()
    {
        ...
        Console.WriteLine("2. Wyœwietl czujniki");
        Console.Write("Opcja: ");
        string opcja = Console.ReadLine();
    ...
    {
        Console.Clear();
        Console.WriteLine("1. Dodaj zg³oszenie");
        Console.WriteLine("2. Wyœwietl zg³oszenia");
        Console.WriteLine("3. Zmieñ status zg³oszenia");
        Console.Write("Opcja: ");
        string opcja = Console.ReadLine();
        ...
        if (opcja == "1")
        {
            ...
            Console.Write("Zg³aszaj¹cy: "); string zg = Console.ReadLine();
        ...
        {
            Console.Write("Podaj ID zg³oszenia: "); int id = int.Parse(Console.ReadLine());
            var zgl = usterki.Find(x => x.id == id);
            if (zgl == null) { Console.WriteLine("Nie znaleziono zg³oszenia"); return; }
    ...
    {
        Console.Clear();
        Console.Write("ID zg³oszenia: "); int id = int.Parse(Console.ReadLine());
        Console.Write("Opis: "); string opis = Console.ReadLine();
        usterki.Add(new ZgloszenieUsterki(id, opis, Zalogowany.imie));
        baza.ZapiszUsterki(usterki);
        Console.WriteLine("Zg³oszenie dodane.");
    }
    #endregion
    ...
    {
        Console.Clear();
        Console.WriteLine("1. Wejœcie u¿ytkownika");
        Console.WriteLine("2. Wyjœcie u¿ytkownika");
        Console.WriteLine("3. Poka¿ logi");
        Console.Write("Opcja: ");
        string opcja = Console.ReadLine();

        if (opcja != "3")
        {
            Console.Write("ID u¿ytkownika: ");
            int id = int.Parse(Console.ReadLine());
            var u = uzytkownicy.Find(x => x.id == id);
            if (u == null) { Console.WriteLine("Nie znaleziono u¿ytkownika"); return; }
    ...
    {
        Console.Clear();
        Console.WriteLine("1. Wejœcie do budynku");
        Console.WriteLine("2. Wyjœcie z budynku");
        Console.Write("Opcja: ");
        string opcja = Console.ReadLine();
